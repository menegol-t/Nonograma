...
public class VistaGanar extends JPanel 
{
    ...
    public VistaGanar(Frame frame) 
    {
        ...
        _tableroUsuario = _controlador.conseguirTableroUsuario();
        ...
        int[][] tableroCorrecto = _controlador.conseguirTableroRespuesta();
        
        imprimirMatriz(_tableroUsuario);
    ...
    private void generarContenido() 
    {
        ...
        JPanel panelUsuario = crearPanelTablero("Tu Respuesta", _tableroUsuario);
