...
public class VistaPerder extends JPanel 
{
    ...
    private int[][] _tableroIncorrecto;
    private int[][] _tableroCorrecto;
    ...
    public VistaPerder(Frame frame) 
    {
        ...
        _tableroIncorrecto = _controlador.conseguirTableroUsuario();
        _tableroCorrecto = _controlador.conseguirTableroRespuesta();
    ...
    private void generarContenido() 
    {
        ...
        JPanel panelUsuario = crearPanelTablero("Tu Respuesta", _tableroIncorrecto);
        panelesTablero.add(panelUsuario);
        
        JPanel panelCorrecto = crearPanelTablero("La Respuesta Correcta", _tableroCorrecto);
    ...
    private JPanel crearPanelTablero(String titulo, int[][] tablero) 
    {
        ...
        JPanel tableroGrid = new JPanel(new GridLayout(_tamanio, _tamanio, 2, 2));
