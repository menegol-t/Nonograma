...
public class vistaMenuInicio extends JPanel
{
	...
	{
		titulo = new JLabel(TITULO_APP, SwingConstants.CENTER);
	...
	{
		botonComoJugar.addActionListener(evento -> 
        {
        	
        	controller.crearVistaComoJugar();
            controller.mostrarVista("como jugar");
        });
	}

	private void agregarAccionLIstaDeModos() 
	{
		listaDeModos.addActionListener(evento -> 
        {
            String opcionSeleccionada = (String) listaDeModos.getSelectedItem();
