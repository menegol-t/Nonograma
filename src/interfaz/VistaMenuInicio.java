...
public class VistaMenuInicio extends JPanel
{
    ...
    private int _tamanioSeleccionado;
	...
	private void agregarAccionDeJugar() 
	{
        ...
        {
        	_controlador.generarJuego(_tamanioSeleccionado);
	...
	private void agregarAccionLIstaDeModos() 
	{
		_listaDeModos.addActionListener(evento -> 
        {
            ...
            System.out.println("Largo seleccionado: " + _tamanioSeleccionado);
        });
	}

    private void definirLargoTableroElegido(String opcionSeleccionada) {
        if (opcionSeleccionada.equals("5x5")) _tamanioSeleccionado = 5;
        else if (opcionSeleccionada.equals("10x10")) _tamanioSeleccionado = 10;
        else if (opcionSeleccionada.equals("15x15")) _tamanioSeleccionado = 15;
    }
    
    public int getTamanioSeleccionado()
    {
    	return _tamanioSeleccionado;
    }
