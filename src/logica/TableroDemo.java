...
public class TableroDemo {
    ...
    private TableroDemo(int[][] tablero, int[][]referenciasCol, int[][] referenciasFila) 
    {
        _tablero = tablero;
    ...
    public static TableroDemo generarJuego(int largoDelTablero)
    {
        ...
        return new TableroDemo(tablero, rleferenciasCol, referenciasFila);
    }
